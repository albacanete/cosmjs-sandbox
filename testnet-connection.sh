...
export NODE_MONIKER=gaia-node-test # only really need to change this one
export BINARY=gaiad
...
export STATE_SYNC=false # if you set this to true, please have TRUST HEIGHT and TRUST HASH and RPC configured
